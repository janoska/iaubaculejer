...
public class UserManager {
    ...
    public ArrayList<String[]> getAllUsersForRank() {
        ...
        ArrayList<Integer> romana = new ArrayList<>();
        ArrayList<Integer> istorie = new ArrayList<>();
        ArrayList<Integer> geografie = new ArrayList<>();
        ArrayList<Integer> biologie = new ArrayList<>();
        ArrayList<Integer> anatomie = new ArrayList<>();
